...
export default function MobiSideBar({ isOpen, onClose } ){
        ...
        <div className="p-4 border-b">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <img src="/placeholder.svg?height=32&width=32" alt="CodeAnt AI" className="h-8 w-8" />
          ...
          <button className="mt-4 w-full flex items-center justify-between px-2 py-1.5 text-sm text-gray-700 rounded hover:bg-gray-100">
